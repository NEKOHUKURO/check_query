...
SELECT * FROM Products WHERE ProductName BETWEEN 'A' AND 'aaaa' ORDER BY ProductName; 
...
CREATE TABLE Orders (     ID int NOT NULL,     OrderNumber int NOT NULL,     OrderDate date DEFAULT CURRENT_DATE() );
